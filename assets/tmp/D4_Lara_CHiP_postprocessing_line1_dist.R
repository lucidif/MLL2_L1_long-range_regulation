...
paths=c(#"in/test_chipseq_downstream/deeptools_heatmaps_filtered_by_diffDoubleKO/K4me3_distal_CpG_plus_Double_KO_vs_F_F.bed",
        #"in/test_chipseq_downstream/deeptools_heatmaps_filtered_by_diffDoubleKO/K4me3_distal_CpG_minus_Double_KO_vs_F_F.bed",
        #"in/test_chipseq_downstream/deeptools_heatmaps_filtered_by_diffDoubleKO/K4me3_proximal_CpG_plus_Double_KO_vs_F_F.bed",
        #"in/test_chipseq_downstream/deeptools_heatmaps_filtered_by_diffDoubleKO/K4me3_proximal_CpG_minus_Double_KO_vs_F_F.bed",
        "outs/dcp_lossk4me3_near_k27ac_heatmap/thr5_dcp_lossk4me3_near_D4_k27ac.bed",
        "outs/dcp_lossk4me3_near_k27ac_heatmap/thr5_dcm_lossk4me3_near_D4_k27ac.bed"
)

dis_name<-c(
#"K4me3_distal_CpG_plus_Double_KO_vs_F_F",
#"K4me3_distal_CpG_minus_Double_KO_vs_F_F",
#"K4me3_proximal_CpG_plus_Double_KO_vs_F_F",
#"K4me3_proximal_CpG_minus_Double_KO_vs_F_F",
"dcp_lossk4me3_near_D4_k27ac",
"dcm_lossk4me3_near_D4_k27ac"
)
...
for (i in 1:length(dis_name)){
  ...
  d<-read.table(paste0(paths[i]),sep="\t")
  ...
  distances_list[length(distances_list)+1]<-dis_name[i]
  assign(dis_name[i],distances)
...
npeaks_dcm_under1kb<-length(which(df$group=="K4me3_distal_CpG_minus_Double_KO_vs_F_F" & df$distance <= 1000))
n_peaks_dcm_tot<-length(which(df$group=="K4me3_distal_CpG_minus_Double_KO_vs_F_F"))

# Basic ECDF plot

#df<-df[which(df$group!="K4me3_proximal_Double_KO_vs_F_F"),]
...
cum_dist<-ggplot(df, aes(distance, colour = group)) + 
  ...
  scale_color_manual(values = c(
                                "dcp_lossk4me3_near_D4_k27ac" = "black",
                                "dcm_lossk4me3_near_D4_k27ac" = "gray"
  )) +
