...
#setwd("/mnt/datawk1/analysis/Lara/Lara_multiomic_analysis/")
#setwd("/media/lucio/easystore/Lucio/Analysis/Lara/Lara_multiomic_analysis/")
...
proximal_dko_vs_wt<-read.table("outs/great/Double_KO_vs_F_F/nearest/K4me3_proximal_Double_KO_vs_FF/20250123-public-4.0.4-dq6pJp-mm10-all-gene.txt",
                               sep="\t",
                               header=FALSE
)
...
source("/home/lucio/wkdir/projects/MLL2_L1_regulation/git/downstream_multiomic/bin/hypergeometric.R")
...
# nodown = geni in proximal_dko_wt_loose ma non in down (D4)
set1 <- unique(tss_inside_proximal$gene)
set2 <- unique(intg_preaktss2[which(intg_preaktss2$V2 == "down"), "intg"])
